...
COMPACT_CROP_CENTER = {
    "early_access": 0.50,
    # Global kompakt: Ausschnitt weiter nach oben ziehen,
    # damit die Oberköpfe knapp an der oberen Kartenkante sitzen.
    "global_launch": 0.30,
}
...
            "Kein
Hintergrundbild für Content gesetzt."
...
#   oberer Abstand
GLOBAL = unterer Abstand 36 TAGE
...
#   oberer Abstand
EARLY ACCESS = unterer Abstand 31 TAGE
...
    # EARLY –
SYMMETRISCHER AUSSENABSTAND

    #

    # Abstand oben von
EARLY ACCESS wird 1:1 als Abstand
...
    # GLOBAL bleibt
oben exakt bei 60 px.

    #

    # Also endet 36
TAGE exakt 60 px vor der Unterkante.
...
    if
milestone["key"] == "global_launch":

        return
create_global_launch_full_card(
...
# wurde, liefert Discord 404. Dann wird nur diese eine
Nachricht
...
    early_changed =
update_or_create_discord_image(
...
        if
milestone["key"] not in wanted_keys:
